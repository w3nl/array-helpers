...
[![NPM version][npm-image]][npm-url] [![Downloads][downloads-image]][npm-stats] ![Node CI][build-image] [![Coveralls Status][coveralls-image]][coveralls-url] [![Scrutinizer Code Quality][scrutinizer-image]][scrutinizer-url]
